...
public class ConnectionFactory {
  ...
  public static Connection getConnection() throws SQLException, ClassNotFoundException {
    if (con == null || con.isClosed()) {
      ...
      con = DriverManager.getConnection("jdbc:phoenix:ip-172-31-13-31.us-west-1.compute.internal:2181,ip-172-31-13-33.us-west-1.compute.internal:2181,ip-172-31-13-30.us-west-1.compute.internal:2181");
    }
    return con;
  }
}
